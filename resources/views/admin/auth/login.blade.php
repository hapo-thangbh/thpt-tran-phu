...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="{{ asset('include/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <!-- Theme style -->
...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <p class="mb-1">
                <a href="{{ route('adminReset') }}">I forgot my password</a>
            </p>
{{--            <p class="mb-0">--}}
...
<!-- AdminLTE App -->
<script src="{{ asset('include/dist/js/adminlte.min.js') }}"></script>
